...
import {
  LayoutDashboard, Package, ShoppingCart, BarChart2, Users, LogOut, User,
  Pill, Menu, X, ChevronRight, ClipboardList, Monitor, TrendingUp,
  FileText, ShoppingBag, Boxes, LayoutList,
} from 'lucide-react';
...
const activeStyle = {
  ...
  boxShadow: `0 4px 16px oklch(55% 0.18 207.078 / 0.28)`,
};
...
export default function AppLayout() {
  ...
  const Sidebar = () => (
    <div
      ...
      style={{ borderRight: '1px solid oklch(93% 0.03 207.078)' }}
    >
      {/* Brand */}
      <div
      ...
      >
        <div
          ...
          style={{
            background: `linear-gradient(135deg,${BM},${B})`,
            boxShadow: `0 4px 14px oklch(55% 0.18 207.078 / 0.35)`,
          }}
        >
      ...
      <nav className="flex-1 px-3 py-5 space-y-0.5 overflow-y-auto">
        ...
        <div
          ...
          style={{ background: 'oklch(93% 0.03 207.078)' }}
        />
        <p className="px-3.5 text-[10px] font-bold text-slate-300 uppercase tracking-widest mb-1">
          Reports
        </p>
      ...
      <div className="p-3" style={{ borderTop: '1px solid oklch(93% 0.03 207.078)' }}>
        ...
        >
          ...
          >
            <div
              className="w-8 h-8 rounded-xl flex items-center justify-center text-[11px] font-extrabold text-white flex-shrink-0"
              style={{
                background: getGrad(user?.firstName),
            ...
            <div className="flex-1 min-w-0">
              <p className="font-bold text-slate-700 text-xs truncate leading-tight">
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-100">
      {/* Desktop sidebar */}
      <aside
        className="hidden lg:flex flex-col w-[230px] flex-shrink-0"
        style={{ boxShadow: `4px 0 24px oklch(55% 0.18 207.078 / 0.06)` }}
      >
        <Sidebar />
      </aside>
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          />
          <aside className="relative z-10 w-[230px] h-full shadow-2xl">
            <Sidebar />
          </aside>
        </div>
      )}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            <button
              onClick={() => setOpen((v) => !v)}
              className="lg:hidden p-2 rounded-xl text-slate-400 hover:bg-slate-100 transition-all"
            >

...
import {
  ...
  Pill, Menu, X, ChevronRight, TrendingUp, FileText, ShoppingBag, Boxes, LayoutList,
} from 'lucide-react';
...
const activeStyle = { background: `linear-gradient(135deg,${BM},${B})`, boxShadow: `0 4px 16px oklch(55% 0.18 207.078 / 0.28)` };
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between px-4 py-3 bg-white"
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => setOpen(v => !v)} className="lg:hidden p-2 rounded-xl text-slate-400 hover:bg-slate-100 transition-all">

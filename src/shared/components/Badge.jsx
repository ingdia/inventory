const Badge = ({ children, variant = 'default' }) => {
  const styles = {
    ...
    cyan:     { className: 'ring-1', style: { background: 'oklch(96% 0.04 207.078)', color: 'oklch(45% 0.18 207.078)', ringColor: 'oklch(86.5% 0.127 207.078)' } },
    danger:   { className: 'bg-red-50 text-red-600 ring-1 ring-red-200' },
    crimson:  { className: 'bg-red-100 text-red-800 ring-1 ring-red-300' },
    warning:  { className: 'bg-amber-50 text-amber-700 ring-1 ring-amber-200' },
    info:     { className: 'ring-1', style: { background: 'oklch(96% 0.04 207.078)', color: 'oklch(45% 0.18 207.078)' } },
  };

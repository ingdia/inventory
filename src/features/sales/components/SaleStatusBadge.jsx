...
export default function SaleStatusBadge({ status = 'completed' }) {
  const normalized = String(status || 'completed').toLowerCase();
  const styleClass = STATUS_STYLES[normalized] || 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400';
